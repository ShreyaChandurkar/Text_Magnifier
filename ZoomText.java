...
class ZoomText {
    ...
    public ZoomText() throws AWTException {
        robot = new Robot();
        gui = new JPanel(new BorderLayout(2, 2));
        output = new JLabel("Put the cursor on something to see it zoomed");
    ...
    public static void main(String[] args) {
        Runnable r = () -> {
            try {
                final ZoomText zm = new ZoomText();
                final JFrame f = new JFrame("Anything Zoom");
